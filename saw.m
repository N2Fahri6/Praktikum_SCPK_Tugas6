...
% Last Modified by GUIDE v2.5 20-Jun-2021 16:52:07
...
% handles    structure with handles and user data (see GUIDATA)
axes(handles.axes1);
imshow('kriteriaMasa.PNG'); %memunculkan gambar
...
% handles    structure with handles and user data (see GUIDATA)
axes(handles.axes3);
imshow('penilaianKinerjaKaryawan.PNG'); %memunculkan gambar
...
% handles    structure with handles and user data (see GUIDATA)
axes(handles.axes2);
imshow('penilaianPerilakuKaryawan.PNG'); %memunculkan gambar
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
opts = detectImportOptions('KriteriaKaryawan.xlsx');
opts.SelectedVariableNames = (1:3);
data = readmatrix('KriteriaKaryawan.xlsx', opts);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
bk1 = str2double(get(handles.edit1,'String'));
bk2 = str2double(get(handles.edit2,'String'));
bk3 = str2double(get(handles.edit3,'String'));
...
p = sort (hasil, 'descend')
set (handles. uitable3, 'data', p);
